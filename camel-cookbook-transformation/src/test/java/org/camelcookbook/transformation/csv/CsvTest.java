...
public class CsvTest extends CamelTestSupport {
    ...
    public void testCsvMarshal() throws Exception {
        ...
        log.info(response);
        final String expects = "Camel in Action,Claus Ibsen,Jon Anstey,Dec-2010,49.99\n" +
                "Camel Cookbook,Scott Cranton,Jakub Korab,Dec-2013,49.99\n";
        assertEquals(expects, response);
    }

    @Test
    public void testCsvUnmarshal() throws Exception {
        final String request = "Camel in Action,Claus Ibsen,Jon Anstey,Dec-2010,49.99\n" +
                "Camel Cookbook,Scott Cranton,Jakub Korab,Dec-2013,49.99\n";
